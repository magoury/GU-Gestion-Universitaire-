...
export function HomeIcon({ className = "" }) {
  return (
    <svg className={`${baseSvgClasses} ${className}`} viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function ParentIcon({ className = "" }) {
  return (
    <svg className={`${baseSvgClasses} ${className}`} viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const UniversitiesIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
    viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" 
    className={className} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21h10.5V18a1.5 1.5 0 0 0-1.5-1.5h-7.5A1.5 1.5 0 0 0 6.75 18v3Z" />
...
export const DotsVerticalIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
    viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" 
    className={className} {...props}>
